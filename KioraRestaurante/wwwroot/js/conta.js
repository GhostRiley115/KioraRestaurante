// CONTA: cadastro, login, perfil, senhas e recuperação.
// Os comentários de cada funcionalidade foram preservados na extração.
(() => {
"use strict";
...
// O conta.js é carregado depois do HTML dos modais e do JavaScript do Bootstrap.
(() => {
...
if (formLogin) {
    ...
    formLogin.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            // Envia os dados para o Controller.
            const resposta = await fetch(formLogin.action, {
                method: "POST",
                body: dados
            });
...
//
// Essa verificação é importante porque o conta.js
...
if (formEditarPerfil) {
    ...
    formEditarPerfil.addEventListener("submit", async function (evento) {
        ...
        try {
            ...
            // do ContaController.
            const resposta = await fetch(formEditarPerfil.action, {
                method: "POST",
                body: dados
            });
    ...
    formAlterarSenha.addEventListener(
        ...
        async function (evento) {
            ...
            try {
                ...
                // Envia os dados para o ContaController.
                const resposta = await fetch(
                    formAlterarSenha.action,
                    {
                        method: "POST",
                        body: dados
                    }
...
if (formEsqueciSenha) {
    ...
    formEsqueciSenha.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            const resposta = await fetch(formEsqueciSenha.action, {
                method: "POST",
                body: dados
            });
